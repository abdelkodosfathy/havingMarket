            ...
            <label className="user-profile-avatar" htmlFor="profilePicInput">
              {profileData.profile_pic ? (
                ...
                <i
                  ...
                  alt={t("profile.addProfileImageAlt")}
                ></i>
              )}
            </label>
            {/* Hidden file input */}
            ...
            <div className="card-block">
              ...
              <div className="row">
                <div className="col-sm-6">
                  <p className="m-b-10 f-w-600">{t("profile.email")}</p>
                  <h6 className="text-muted f-w-400">{profileData.email}</h6>
                </div>
                <div className="col-sm-6">
                  <p className="m-b-10 f-w-600">{t("profile.phone")}</p>
                      ...
                      <label>
                        <div>
                          {phoneErrors.phone ? (
                            ...
                            <p>{t("profile.updatePhonePrompt")}</p>
                          )}
                          <input
                            style={{
                              display: "block",
                ...
                <>
                  ...
                  {passwordChangeError && (
                    <p className="error-message">
                      {t("profile.passwordUpdatedError")}
                    </p>
                  )}
